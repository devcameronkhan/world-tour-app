...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        @endif
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Airport /</span> Add</h4>

        <form id="page-create-form" action="{{ route('airports.store') }}" enctype="multipart/form-data" method="POST">
            @csrf
            <!-- Basic Layout -->
            <div class="row">
                ...
                <div class="col-sm-8 col-md-12 col-lg-12">
                    <div class="card mb-4">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h5 class="mb-0">Add Airport</h5>
                        </div>
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-sm-4">
                                    <label for="code" class="form-label">code</label>
                                    <input type="text" value="{{ old('code') }}" placeholder="Enter Airport Code"
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input type="text" value="{{ old('city_code') }}"
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input type="text" value="{{ old('name') }}" placeholder="Enter Airport Name"
                                ...
                                <div class="col-sm-4 mt-4">
                                    ...
                                    <input type="text" value="{{ old('city') }}" required
                                ...
                                <div class="col-sm-4  mt-4">
                                    ...
                                    <select class="form-control" required name="timezone" id="timezone">
                                        ...
                                        @foreach ($timezones as $timezone)
                                            <option @if (old('timezone') == $timezone->value) selected @endif
