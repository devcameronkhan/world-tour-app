...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        @endif
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Airline /</span> Edit</h4>

        <form id="add-airline-form" action="{{ route('airlines.update',$airline->id) }}" enctype="multipart/form-data" method="POST">
            @csrf
            @method('put')
            <!-- Basic Layout -->
            <div class="row">
                        ...
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" value="{{ $airline->code }}" placeholder="Enter Airline Code"
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" value="{{ $airline->name }}" placeholder="Enter Airline Name"
